...
static void mpu6050GyroInit(sensor_align_e align)
{
    ...
    //i2cWrite(MPU6050_ADDRESS, MPU_RA_INT_ENABLE, BIT_RAW_RDY_EN);            // INT: Raw data ready
    //#define BIT_INT_ANYRD_2CLEAR        0x10
    //i2cWrite(MPU6050_ADDRESS, MPUREG_INT_PIN_CFG, BIT_INT_ANYRD_2CLEAR);     // INT: Clear on any read
